      ...
      >
        ...
        <motion.nav variants={item} className="flex justify-between items-center glass-card px-8 py-4 rounded-3xl mb-12">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium ink-text/70 uppercase tracking-widest">
             <Link href="/studio" className="hover:text-[#2a2e1a] transition-colors">Studio</Link>
             <Link href="/agora" className="hover:text-[#2a2e1a] transition-colors">The Agora</Link>
             <Link href="/marketplace" className="hover:text-[#2a2e1a] transition-colors">Marketplace</Link>
          </div>
          <Link href="/login">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
             <motion.div variants={item} className="inline-flex items-center gap-2 glass-border px-4 py-1.5 rounded-full text-xs font-semibold uppercase tracking-widest ink-text/60 bg-[#4a5033]/5">
                <Sparkles size={12} className="text-[#2a2e1a]" />
                The First Complete Writing Ecosystem
             </motion.div>
             
             <motion.h1 variants={item} className="text-5xl md:text-7xl font-serif text-[#2a2e1a] leading-[1.1] tracking-tight font-black italic">
                Craft Your Masterpiece. <br />
                <span className="opacity-60 italic font-medium">Earn Your Ink.</span>
             </motion.h1>
             
             <motion.p variants={item} className="text-lg md:text-xl text-[#2a2e1a]/70 font-light leading-relaxed max-w-xl mx-auto lg:mx-0">
...
<GlassCard
  className="aspect-[4/5] flex flex-col relative overflow-hidden p-8 border-[#4a5033]/20"
  style={{
    background: "#CCD1B8",
    boxShadow:
      "0 12px 30px rgba(74, 80, 51, 0.08), inset 0 1px 0 rgba(255,255,255,0.18)",
    border: "1px solid rgba(74, 80, 51, 0.08)"
  }}
>
                ...
                <div className="font-serif text-[#2a2e1a] space-y-6 leading-relaxed flex-1 italic background: #C4C9AE">
             ...
             >
                <PenTool size={32} className="text-[#2a2e1a]" />
             </motion.div>
          </motion.div>
        </div>
            ...
            {[
              ...
              <GlassCard key={idx} className="group hover:scale-105 border-[#4a5033]/10 hover:border-[#4a5033]/30">
                <div className="w-12 h-12 rounded-2xl bg-[#4a5033]/5 flex items-center justify-center mb-6">
                   <feature.icon size={24} className="text-[#2a2e1a]" />
                </div>
                <h3 className="text-xl font-serif font-black mb-2 italic">{feature.title}</h3>
                <p className="text-sm text-[#2a2e1a]/60 leading-relaxed italic">{feature.desc}</p>
              </GlassCard>
            ))}
        </motion.div>
      </motion.div>
