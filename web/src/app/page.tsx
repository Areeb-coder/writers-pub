   ...
   return (
      <main className="min-h-screen flex flex-col items-center justify-center p-6 sm:p-24 overflow-hidden">
         ...
         >
            ...
            <motion.nav
               variants={item}
               className="relative z-50 flex justify-between items-center glass-card px-5 sm:px-8 py-4 rounded-3xl mb-12"
            >
               ...
               <AnimatePresence>
                  {mobileMenuOpen && (
                     <motion.div
                        ...
                        className="absolute top-[110%] left-0 right-0 md:hidden rounded-3xl p-6 border border-[#4a5033]/15 overflow-hidden shadow-2xl shadow-[#4a5033]/20 z-50 bg-[#e8e7d8]/95 backdrop-blur-2xl"
                     >
                        <div className="flex flex-col gap-6 text-sm font-medium ink-text/80 uppercase tracking-widest">
                           <Link
                              href="/studio"
                           ...
                           <Link
                              ...
                              onClick={() => setMobileMenuOpen(false)}
                           >
                              <InkButton className="w-full justify-center py-3 rounded-2xl mt-2">
                                 Sign In
                              </InkButton>
                           </Link>
                        </div>
